                            ...
                            <div class="dateCondition">
                                <div class="contentCondition">
                                    ...
                                    <div class="dateInputDiv">
                                        <input id="date" readonly placeholder="点击选择筛选日期" name="date" value="">
...
<script type="text/javascript">
    ...
    $("button.nowQueryBtn").on("click", function () {
        ...
        window.location.href = baseUrl + "/merchant/buffetFood/order/done?startTime=" + dateValList[0] + "&endTime=" + dateValList[1];
    })
</script>
</html>
