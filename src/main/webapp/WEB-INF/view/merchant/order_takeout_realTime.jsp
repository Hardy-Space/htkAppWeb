...
<head>
    ...
    <!-- confirm CSS -->
    <link rel="stylesheet" href="${staticFilePath}resource/custom/plugins/jquery-confirm/jquery-confirm.css"/>
</head>
<body>
    ...
    <div class="layui-body" style="background-color: #f3f3f4">
        <div class="body-content">
            <div class="childCatO clearfix tab top-tab">
                <a href="${sysPath}merchant/takeout/order/realTimeTakeoutOrder" class="cur">实时订单</a>
                <a href="${sysPath}merchant/takeout/order/historyTakeoutOrder">历史订单</a>
            </div>
            <div class="orderPage">
                <div class="orderTop">
                        ...
                        <div class="filterCheck clearfix">
                            <c:choose>
                                <c:when test="${statusCode == 0}">
                                    <label><input type="radio" id="newOrd" name="filter1" value="1" checked/>
                                        新订单</label>
                                    <label><input type="radio" id="oldOrd" name="filter1" value="2"/> 已处理</label>
                                </c:when>
                                <c:otherwise>
                                    <label><input type="radio" id="newOrd" name="filter1" value="1"/> 新订单</label>
                                    <label><input type="radio" id="oldOrd" name="filter1" value="2" checked/>
                                        已处理</label>
                                </c:otherwise>
                            </c:choose>
                        </div>
                            ...
                            <div class="filterCheck clearfix">
                                <c:choose>
                                    <c:when test="${statusCode == 1}">
                                        <label><input type="radio" id="dPSOrd" name="filter2" value="1" checked/>
                                            待配送</label>
                                    </c:when>
                                    <c:otherwise>
                                        <label><input type="radio" id="dPSOrd" name="filter2" value="1"/> 待配送</label>
                                    </c:otherwise>
                                </c:choose>
                                <c:choose>
                                    <c:when test="${statusCode == 2}">
                                        <label><input type="radio" id="pSZOrd" name="filter2" value="2" checked/>
                                            配送中</label>
                                    </c:when>
                                    <c:otherwise>
                                        <label><input type="radio" id="pSZOrd" name="filter2" value="2"/> 配送中</label>
                                    </c:otherwise>
                                </c:choose>
                                <c:choose>
                                    <c:when test="${statusCode == 3}">
                                        <label><input type="radio" id='ySHOrd' name="filter2" value="3" checked/>
                                            已收货</label>
                                    </c:when>
                                    <c:otherwise>
                                        <label><input type="radio" id='ySHOrd' name="filter2" value="3"/> 已收货</label>
                                    </c:otherwise>
                                </c:choose>
                                <c:choose>
                                    <c:when test="${statusCode == 4}">
                                        <label><input type="radio" id='cDOrd' name="filter2" value="4" checked/>
                                            催单</label>
                                    </c:when>
                                    <c:otherwise>
                                        <label><input type="radio" id='cDOrd' name="filter2" value="4"/> 催单</label>
                                    </c:otherwise>
                                </c:choose>
                                <c:choose>
                                    <c:when test="${statusCode == 5}">
                                        <label><input type="radio" id='qXOrd' name="filter2" value="5" checked/>
                                            取消单</label>
                                    </c:when>
                                    <c:otherwise>
                                        <label><input type="radio" id='qXOrd' name="filter2" value="5"/> 取消单</label>
                                    </c:otherwise>
                                </c:choose>
                            </div>
                        </div>
                ...
                <div class="orderList clearfix">
                                    ...
                                    <c:when test="${statusCode == 0}">
                                        <c:if test="${data != null}">
                                            <c:forEach items="${data}" var="each" varStatus="i">
                                                ...
                                                <div class="goodsInfo">
                                                    <div class="uname">商品信息<a href="javascript:void(0);">收起</a></div>
                                                    <div class="payed">
                                            ...
                                            <c:forEach items="${data}" var="each" varStatus="i">
                                                ...
                                                <div class="buttons">
                                                    <a href="javascript:void(0)" class="delivery"
                                                       data-num="${each.orderNumber}">立即配送</a>
                                                </div>
                                                <p class="orderSn">${fn:substring(each.orderTime,5 , 19)} 下单 |
                                                    订单编号：${each.orderNumber}</p>
                                            </c:forEach>
                    ...
                    <div class="orderRight">
                        ...
                        <div class="orderNum">
                            <span>待 发 配 送：<i>${stateCount}</i>笔</span>
                            <a href="">查看订单 &gt;</a>
                        </div>
                    </div>
                </div>
...
<%@include file="js.jsp" %>
<!-- confirm JS -->
<script src="${staticFilePath}resource/custom/plugins/jquery-confirm/jquery-confirm.js"></script>
